...
class Command(BaseCommand):
  ...
  def handle(self, *args, **options):
    ...
    # 2. Call pmod mod
    mod = composite.mods.create(id_token=generate_id_token('img', 'Mod'), algorithm='mod_step09_regions')

    # 3. Run mod
    print('step09 | processing mod_step09_regions...', end='\r')
    mod.run()
    print('step09 | processing mod_step09_regions... done.')
